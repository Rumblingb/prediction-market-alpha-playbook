...
3. **`EDGES.md`** — pick **one** edge to implement first. Favor low-complexity structural arbs (e.g., NEG_RISK sum arb, within-market YES+NO<1) over ML-style directional bets.
